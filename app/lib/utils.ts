...
export const formatCurrency = (amount: number) => (amount / 100).toLocaleString('en-US', { style: 'currency', currency: 'USD' });

export const formatDateToLocal = (dateStr: string, locale: string = 'en-US') => new Intl.DateTimeFormat(locale, { day: 'numeric', month: 'short', year: 'numeric' }).format(new Date(dateStr));
